...
module m_matrix_tb;
    ...
    localparam int H_WIDTH       = 16;
    localparam int ROUNDED_WIDTH = 32;
    parameter string A_SIGNED      = "no";
    parameter string SIGNED_RES    = "yes";
    localparam string USE_DSP_VALUE = "yes";
...
//    logic [ROUNDED_WIDTH-1:0] m22_re, m22_im;
    ...
    logic [A_WIDTH+H_WIDTH-1:0] cmult1_reg_m11_re, cmult1_reg_m11_im;
    logic [A_WIDTH+H_WIDTH-1:0] cmult1_reg_m12_re, cmult1_reg_m12_im;
    logic [A_WIDTH+H_WIDTH-1:0] cmult1_reg_m21_re, cmult1_reg_m21_im;
    logic [A_WIDTH+H_WIDTH-1:0] cmult1_reg_m22_re, cmult1_reg_m22_im;
    
    logic [A_WIDTH+H_WIDTH:0] cmult2_reg_m11_re, cmult2_reg_m11_im;
    logic [A_WIDTH+H_WIDTH:0] cmult2_reg_m12_re, cmult2_reg_m12_im;
    logic [A_WIDTH+H_WIDTH:0] cmult2_reg_m21_re, cmult2_reg_m21_im;
    logic [A_WIDTH+H_WIDTH:0] cmult2_reg_m22_re, cmult2_reg_m22_im;
    logic [A_WIDTH+H_WIDTH+1:0] sum_reg_m11_re, sum_reg_m11_im;
    logic [A_WIDTH+H_WIDTH+1:0] sum_reg_m12_re, sum_reg_m12_im;
    logic [A_WIDTH+H_WIDTH+1:0] sum_reg_m21_re, sum_reg_m21_im;
    logic [A_WIDTH+H_WIDTH+1:0] sum_reg_m22_re, sum_reg_m22_im;
    
    logic [ROUNDED_WIDTH-1:0] round_m11_re, round_m11_im;
    logic [ROUNDED_WIDTH-1:0] round_m12_re, round_m12_im;
    logic [ROUNDED_WIDTH-1:0] round_m21_re, round_m21_im;
    logic [ROUNDED_WIDTH-1:0] round_m22_re, round_m22_im;
