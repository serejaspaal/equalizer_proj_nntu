...
module cmult_a_real_b_coupl_tb;
	...
	a_s = -128; a_u = 0; x1 = -128; y1 = 127; @(posedge clk);
        ...
        if (out_re_s !== exp_re_s || out_im_s !== exp_im_s) begin
            ...
            errors++;
        end else $display("S1 PASS: (-128)*conj(-128-128i) = (%0d,%0d)", out_re_s, out_im_s);
        ...
        if (out_re_s !== exp_re_s || out_im_s !== exp_im_s) begin
            ...
            errors++;
        end else $display("S2 PASS: (-128)*conj(-128+127i) = (%0d,%0d)", out_re_s, out_im_s);
	...
	a_s = -128; a_u = 0; x1 = 127; y1 = 127; @(posedge clk);
        ...
        if (out_re_s !== exp_re_s || out_im_s !== exp_im_s) begin
            ...
            errors++;
        end else $display("S3 PASS: (-128)*conj(127-128i) = (%0d,%0d)", out_re_s, out_im_s);
        ...
        if (out_re_s !== exp_re_s || out_im_s !== exp_im_s) begin
            ...
            errors++;
        end else $display("S4 PASS: (-128)*conj(127+127i) = (%0d,%0d)", out_re_s, out_im_s);
        ...
        if (out_re_s !== exp_re_s || out_im_s !== exp_im_s) begin
            ...
            errors++;
        end else $display("S5 PASS: (127)*conj(-128-128i) = (%0d,%0d)", out_re_s, out_im_s);
	...
	a_s = 127; a_u = 0; x1 = 127; y1 = -128; @(posedge clk);
        ...
        if (out_re_s !== exp_re_s || out_im_s !== exp_im_s) begin
            ...
            errors++;
        end else $display("S6 PASS: (127)*conj(-128+127i) = (%0d,%0d)", out_re_s, out_im_s);
        ...
        if (out_re_s !== exp_re_s || out_im_s !== exp_im_s) begin
            ...
            errors++;
        end else $display("S7 PASS: (127)*conj(127-128i) = (%0d,%0d)", out_re_s, out_im_s);
        ...
        if (out_re_s !== exp_re_s || out_im_s !== exp_im_s) begin
            ...
            errors++;
        end else $display("S8 PASS: (127)*conj(127+127i) = (%0d,%0d)", out_re_s, out_im_s);
	...
	a_s = 0; a_u = 0; x1 = -128; y1 = 127; @(posedge clk);
        ...
        if (out_re_u !== exp_re_u || out_im_u !== exp_im_u) begin
            ...
            errors++;
        end else $display("U1 PASS: 0*conj(-128-128i) = (%0d,%0d)", out_re_u, out_im_u);
        ...
        if (out_re_u !== exp_re_u || out_im_u !== exp_im_u) begin
            ...
            errors++;
        end else $display("U2 PASS: 0*conj(-128+127i) = (%0d,%0d)", out_re_u, out_im_u);
        ...
        if (out_re_u !== exp_re_u || out_im_u !== exp_im_u) begin
            ...
            errors++;
        end else $display("U3 PASS: 0*conj(127-128i) = (%0d,%0d)", out_re_u, out_im_u);
        ...
        if (out_re_u !== exp_re_u || out_im_u !== exp_im_u) begin
            ...
            errors++;
        end else $display("U4 PASS: 0*conj(127+127i) = (%0d,%0d)", out_re_u, out_im_u);
        ...
        if (out_re_u !== exp_re_u || out_im_u !== exp_im_u) begin
            ...
            errors++;
        end else $display("U5 PASS: 255*conj(-128-128i) = (%0d,%0d)", out_re_u, out_im_u);
        ...
        if (out_re_u !== exp_re_u || out_im_u !== exp_im_u) begin
            ...
            errors++;
        end else $display("U6 PASS: 255*conj(-128+127i) = (%0d,%0d)", out_re_u, out_im_u);
        ...
        if (out_re_u !== exp_re_u || out_im_u !== exp_im_u) begin
            ...
            errors++;
        end else $display("U7 PASS: 255*conj(127-128i) = (%0d,%0d)", out_re_u, out_im_u);

	@(posedge clk);
        if (out_re_u !== exp_re_u || out_im_u !== exp_im_u) begin
            $error("U8 FAIL: got (%0d,%0d), expected (%0d,%0d)", out_re_u, out_im_u, exp_re_u, exp_im_u);
            errors++;
        end else $display("U8 PASS: 255*conj(127+127i) = (%0d,%0d)", out_re_u, out_im_u);
