...
module cmodule #(
    ...
    // Stage 0
    (* USE_DSP = USE_DSP_VALUE ? "yes" : "no" *) logic unsigned [2*WIDTH-1:0] re_sq_comb;
    (* USE_DSP = USE_DSP_VALUE ? "yes" : "no" *) logic unsigned [2*WIDTH-1:0] im_sq_comb;
    always_comb begin
        re_sq_comb = Re * Re;
        im_sq_comb = Im * Im;
    end
    ...
    // Stage 2
    (* USE_DSP = USE_DSP_VALUE ? "yes" : "no" *) logic unsigned [2*WIDTH-1:0] sum_comb;
    always_comb begin
